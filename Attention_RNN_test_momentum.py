...
class AttnDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, dropout_p=0.1):
        ...
        self.gru = GRUCell(1024, self.hidden_size, 0.1, 0.1)
        self.gru1 = GRUCell(256, self.hidden_size, 0.1, 0.1)
    ...
    def forward(self, input_a, hidden, v, encoder_outputs,bb,attention_sum,decoder_attention,dense_input,batch_size,h_mask,w_mask,gpu):
